...
function OnLoad()
    ...
    Q = _Spell({Slot = _Q, DamageName = "Q", Range = 950, Width = 85, Delay = 0.25, Speed = 1350, Collision = false, Aoe = true, Type = SPELL_TYPE.LINEAR}):AddDraw()
    W = _Spell({Slot = _W, DamageName = "W", Range = 950, Width = 250, Delay = 0.25, Speed = 1650, Aoe = true}):AddDraw()
    ...
    R = _Spell({Slot = _R, DamageName = "R", Range = 1000, Width = 100, Delay = 0.25, Speed = 2100, Collision = false, Aoe = true}):AddDraw()
    ...
    Menu:addSubMenu(myHero.charName.." - Combo Settings", "Combo")
        ...
        Menu.Combo:addParam("useW", "Use W on AA", SCRIPT_PARAM_ONOFF, true)
