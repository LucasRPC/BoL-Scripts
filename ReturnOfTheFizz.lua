local ScriptName = "ReturnOfTheFizz"
...
function OnLoad()
    ...
    Q = _Spell({Slot = _Q, DamageName = "Q", Range = 550, Width = 75, Delay = 0.5, Speed = 1800, Collision = true, Aoe = false, Type = SPELL_TYPE.TARGETTED}):AddDraw()
    W = _Spell({Slot = _W, DamageName = "W", Range = 125, Width = nil, Delay = 0.25, Speed = 1650, Aoe = false}):AddDraw()
    E = _Spell({Slot = _E, DamageName = "E", Range = 400, Width = nil, Delay = 0.5, Speed = math.huge, Aoe = false}):AddDraw()
    Ignite = _Spell({Slot = FindSummonerSlot("summonerdot"), DamageName = "IGNITE", Range = 600, Type = SPELL_TYPE.TARGETTED})
    R = _Spell({Slot = _R, DamageName = "R", Range = 125, Width = 80, Delay = 0.5, Speed = 1200, Collision = false, Aoe = true, Type = SPELL_TYPE.LINEAR}):AddDraw()
