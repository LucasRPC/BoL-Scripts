...
function OnLoad()
    ...
    Q = _Spell({Slot = _Q, DamageName = "Q", Range = 500, Width = nil, Delay = nil, Speed = math.huge, Collision = false, Aoe = false}):AddDraw()
    W = _Spell({Slot = _W, DamageName = "W", Range = 650, Width = nil}):AddDraw()
    E = _Spell({Slot = _E, DamageName = "E", Range = 275, Width = nil, Delay = 0.25, Speed = math.huge, Aoe = false, Type = SPELL_TYPE.TARGETTED}):AddDraw()
    R = _Spell({Slot = _R, DamageName = "R", Range = 650, Delay = 0.25, Width = 350, Speed = 1300, Collision = false, Aoe = true, Type = SPELL_TYPE.CONE}):AddDraw()
    Ignite = _Spell({Slot = FindSummonerSlot("summonerdot"), DamageName = "IGNITE", Range = 600, Type = SPELL_TYPE.CIRCULAR})
